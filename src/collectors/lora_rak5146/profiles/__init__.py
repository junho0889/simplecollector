...
class ProfileRegistry:
    ...
    def register(cls, profile: DeviceProfile) -> None:
        ...
        logger.debug(f"[LoRa ProfileRegistry] Registered: {profile.name}")
...
# Built-in 프로파일 자동 등록
from .posiot_lora import PosiotLoRaProfile

ProfileRegistry.register(PosiotLoRaProfile())
